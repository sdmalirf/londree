...
class editOutlet extends ConsumerStatefulWidget {
  final Outlets? data;

  editOutlet({super.key, this.data});

  @override
  ConsumerState<editOutlet> createState() => _editOutletState();
}

class _editOutletState extends ConsumerState<editOutlet> {
  int count = 0;
...
//   editOutlet({Key? key, this.data}) : super(key: key);
